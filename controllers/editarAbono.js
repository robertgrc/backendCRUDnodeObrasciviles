...
//   const fechaConsultaObj = fechaConsulta ? new Date(fechaConsulta) : new Date();
...
//       fechaActual: {
//         $gte: fechaConsultaObj, // Filtra por fecha igual o posterior a la fecha de consulta
//         $lt: new Date(fechaConsultaObj.getTime() + 24 * 60 * 60 * 1000), // Hasta el final del día
//       },
//     });
